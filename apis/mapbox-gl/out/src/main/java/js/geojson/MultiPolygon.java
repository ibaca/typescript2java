...
/** 
  * source type: "tsd/geojson/index".MultiPolygon
  * flags: Object (32768)
  * declared in: tsd/geojson/index.d.ts at pos 3570
...
public class MultiPolygon implements GeometryObject 
{
    ...
    */
    ...
    public Array<Array<Array<Array<Number>>>> coordinates;
    ...
    */
    ...
    public native Array<Array<Array<Array<Number>>>> getCoordinates();
    /** 
      * inherited from (js.geojson.GeoJsonObject)
      * inherited from (js.geojson.GeoJsonObject)
      * inherited from (js.geojson.GeoJsonObject)
    ...
    @JsProperty(name = "coordinates")
    public native void setCoordinates(Array<Array<Array<Array<Number>>>> value);
    /** 
      * inherited from (js.geojson.GeoJsonObject)
      * inherited from (js.geojson.GeoJsonObject)
      * inherited from (js.geojson.GeoJsonObject)
