...
/** 
  * source type: "tsd/geojson/index".Point
  * flags: Object (32768)
  * declared in: tsd/geojson/index.d.ts at pos 2571
...
public class Point implements GeometryObject 
{
    ...
    */
    ...
    public Array<Number> coordinates;
    ...
    */
    ...
    public native Array<Number> getCoordinates();
    /** 
      * inherited from (js.geojson.GeoJsonObject)
      * inherited from (js.geojson.GeoJsonObject)
      * inherited from (js.geojson.GeoJsonObject)
    ...
    @JsProperty(name = "coordinates")
    public native void setCoordinates(Array<Number> value);
    /** 
      * inherited from (js.geojson.GeoJsonObject)
      * inherited from (js.geojson.GeoJsonObject)
      * inherited from (js.geojson.GeoJsonObject)
