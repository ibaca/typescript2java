...
/** 
  * source type: "tsd/mapbox-gl/index".RasterSource
  * flags: Object (32768)
  * declared in: tsd/mapbox-gl/index.d.ts at pos 15783

  * *** changed to class to reflect the possible DTO use of this type ***
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="Object")
public class RasterSource implements Source 
{
    ...
    */
    ...
    @JsProperty(name = "tileSize")
    public native Number getTileSize();
    ...
    @JsProperty(name = "tileSize")
    public native void setTileSize(@DoNotAutobox Number value);
    @JsProperty(name = "tiles")
