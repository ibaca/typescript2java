...
public class TupleOf10<A, B, C, D, E, F, G, H, I, J> {
    @JsOverlay
    ...
    @JsOverlay
    public final I getNb9() {
        return (I) Js.asArrayLike(this).getAt(8);
    }
    @JsOverlay
    public final void setNb9(I value) {
        Js.asArrayLike(this).setAt(8, value);
    }
    @JsOverlay
    public final J getNb10() {
        return (J) Js.asArrayLike(this).getAt(9);
    }
    @JsOverlay
    public final void setNb10(J value) {
        Js.asArrayLike(this).setAt(9, value);
    }
    @JsOverlay
